...
export const industries: Industry[] = [
  ...
  },
  {
    ...
    emoji: "💻",
    status: "live",
    blurb: "How software companies build, sell, support, and fund themselves — from a solo founder to a hyperscaler.",
    tagline: "4 workflows mapped — product development, sales & GTM, customer success, fundraising",
    workflowIds: ["product-development", "sales-gtm", "customer-success", "fundraising"],
  },
  {
    id: "healthcare",
    name: "Healthcare",
    emoji: "🩺",
    status: "live",
    blurb: "How you get diagnosed, billed, insured, and prescribed to — from a solo clinic to a national hospital system.",
    tagline: "4 workflows mapped — patient care, medical billing, health insurance, pharma commercialization",
    workflowIds: ["patient-care", "medical-billing", "health-insurance", "pharma-commercialization"],
  },
  {
    ...
    emoji: "🏦",
    status: "live",
    blurb: "How banks, payment processors, wealth managers, and insurers actually make and move money.",
    tagline: "4 workflows mapped — retail banking, payments processing, wealth management, insurance underwriting",
    workflowIds: ["retail-banking", "payments-processing", "wealth-management", "insurance-underwriting"],
  },
  {
    id: "retail",
    ...
    emoji: "🛒",
    status: "live",
    blurb: "How stores and online shops decide what to sell, run their operations, and move product — from a solo Etsy seller to Amazon.",
    tagline: "4 workflows mapped — merchandising, e-commerce operations, store operations, supply chain",
    workflowIds: ["merchandising", "ecommerce-operations", "store-operations", "retail-supply-chain"],
  },
  {
    id: "manufacturing",
    name: "Manufacturing",
    emoji: "🏭",
    status: "live",
    blurb: "How things actually get designed, built, quality-checked, and sourced — from a small job shop to Boeing.",
    tagline: "4 workflows mapped — product engineering, production & assembly, quality & compliance, procurement",
    workflowIds: ["product-engineering", "production-assembly", "quality-compliance", "procurement-supplier"],
  },
  {
    id: "logistics",
    ...
    emoji: "🚚",
    status: "live",
    blurb: "How stuff actually moves — trucking, warehousing, last-mile delivery, and the planning behind it all.",
    tagline: "4 workflows mapped — freight & trucking, warehousing & fulfillment, last-mile delivery, supply chain planning",
    workflowIds: ["freight-trucking", "warehousing-fulfillment", "last-mile-delivery", "supply-chain-planning"],
  },
  {
    id: "legal",
    name: "Legal Services",
    emoji: "⚖️",
    status: "live",
    blurb: "How law firms actually run cases, deals, billing, and compliance — from a solo attorney to Big Law.",
    tagline: "4 workflows mapped — litigation, transactional law, legal ops & billing, compliance & regulatory",
    workflowIds: ["litigation", "transactional-law", "legal-ops-billing", "compliance-regulatory"],
  },
];
